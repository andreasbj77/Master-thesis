...
```{r}
Vestas <- read_csv("E:/Forecast/Vestas/forecast_Vestas") %>% select(Model, RMSE, MAPE)
Genmab <- read_csv("E:/Forecast/Genmab/forecast_Genmab") %>% select(Model, RMSE, MAPE)
Carlsberg <- read_csv("E:/Forecast/Carlsberg/forecast_Carlsberg") %>% select(Model, RMSE, MAPE)
JyskeBank <- read_csv("E:/Forecast/JyskeBank/forecast_JyskeBank") %>% select(Model, RMSE, MAPE)
MaerskB <- read_csv("E:/Forecast/MaerskB/forecast_MaerskB") %>% select(Model, RMSE, MAPE)
SimCorp <- read_csv("E:/Forecast/SimCorp/forecast_SimCorp") %>% select(Model, RMSE, MAPE)
```
