...
```{r}
acf(resid(model_Maersk))
pacf(resid(model_Maersk))
```
...
DM.test(arima_test_fitted1$pred, arima_test_fitted_features2$pred, arima_test_fitted1$truth, h=1, H1="same")


dm.test(arima_test_fitted1$error, arima_test_fitted_features2$error, alternative = "two.sided", h=1)
...
library(rugarch)
DACTest(arima_test_fitted1$pred, arima_test_fitted1$truth, test = "PT", conf.level = 0.10)
```
