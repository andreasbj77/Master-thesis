...
tuner <- Hyperband(
  ...
  objective = "val_mape",
  max_epochs = 10,
  project_name = "Carlsberg_hyper_FNN")
```
...
tuner <- Hyperband(
  ...
  objective = "val_mape",
  max_epochs = 30,
  project_name = "Carlsberg_hyper_RNN")
```
...
tuner <- Hyperband(
  ...
  objective = "val_mape",
  max_epochs = 30,
  project_name = "Carlsberg_hyper_LSTM")
```
...
tuner <- Hyperband(
  ...
  objective = "val_mape",
  max_epochs = 30,
  project_name = "Carlsberg_hyper_biLSTM")
```
...
tuner <- Hyperband(
  ...
  objective = "val_mape",
  max_epochs = 30,
  project_name = "Carlsberg_hyper_GRU")
```
...
tuner <- Hyperband(
  ...
  objective = "val_mape",
  max_epochs = 30,
  project_name = "Carlsberg_hyper_biGRU")
```
...
```{r}
save_model_hdf5(model_ANN, "model_ANN_Carlsberg")
save_model_hdf5(model_RNN, "model_RNN_Carlsberg")
save_model_hdf5(model_LSTM, "model_LSTM_Carlsberg")
save_model_hdf5(model_biLSTM, "model_biLSTM_Carlsberg")
save_model_hdf5(model_GRU, "model_GRU_Carlsberg")
save_model_hdf5(model_biGRU, "model_biGRU_Carlsberg")
Results %>% select(Model, RMSE, MAPE) %>% write.csv("Results_Carlsberg")
```
